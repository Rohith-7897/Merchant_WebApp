...
public class MerchantController {
	...
	public ModelAndView openUdate(ModelAndView modelAndView) {
	...
	@ResponseBody
	public String updateMercahnt(@ModelAttribute(name="m") Merchant merchant) {
		merchant = merchantDao.updateMerchant(merchant);
		if(merchant != null) {
			return "Merchant with Id: "+ merchant.getId()+" updated successfully";
		}
		else {
			return "Cannot update merchant as Id id Invalid";
		}
	}
